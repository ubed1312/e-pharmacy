                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive mb-4">
                                <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                    ...
                                    <tbody>
                                    <?php 
                                    $sql="SELECT * ,count(valid_user) as vu from medicines_order mo , users u , medicines m where mo.id_user=u.username and mo.id_m = m.id and valid='No' and valid_user='oui' and mo.is_deleted='0' group by username ";
